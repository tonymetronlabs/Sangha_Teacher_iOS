...
- (void)scrollToOffset:(CGFloat)scrollOffset animated:(BOOL)animated
{
    if (self.scrollDirection == UICollectionViewScrollDirectionHorizontal) {
        CGFloat step = (self.collectionView.fs_width*((self.scrollDirection==UICollectionViewScrollDirectionHorizontal)?0.5:1)) + 75;
        [_collectionView setContentOffset:CGPointMake(((scrollOffset+0.5)*step) + 100, 0) animated:animated];
    } else {
...
- (void)prepareLayout
{
    ...
    self.itemSize = CGSizeMake(
                               (self.collectionView.fs_width*((self.scrollDirection==UICollectionViewScrollDirectionHorizontal)?0.5:1)) + 75,
